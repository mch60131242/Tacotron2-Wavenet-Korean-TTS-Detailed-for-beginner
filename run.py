...
#based on https://github.com/keithito/tacotron/blob/master/demo_server.py
...
class SynthesisResource:
  def on_get(self, req, res):
    ...
    #!?를 붙여야 뭔가 감정이 실린 Monika가 나옴 이유는 모름
...
if __name__ == '__main__':
  ...
  synthesizer.load("logdir-tacotron2/monika", 2, None, inference_prenet_dropout=False)
